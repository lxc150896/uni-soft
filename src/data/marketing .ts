export const marketing = {
  ...
  "requirements": {
    "experience": [
      "1-2 năm kinh nghiệm trong lĩnh vực digital marketing.",
      "Nếu bạn đặc biệt yêu thích các trò chơi di động và có kinh nghiệm marketing trong mảng mobile thì đó là một lợi thế.",
    ...
    "personality": [
      "Sáng tạo, nhiệt huyết, cởi mở, trách nhiệm và muốn chinh phục."
    ]
  },
  "benefits": [
